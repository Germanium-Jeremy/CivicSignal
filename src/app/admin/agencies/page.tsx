        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by agency name, registration number, or officer..."
                value={searchQuery}
                    ...
                    <tr key={agency._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button
                          ...
                          className="text-accent2 hover:text-accent mr-3"
                        >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-200">
                  {selectedAgency.verificationStatus === 'pending' && (
                    <>
                      <button
                        onClick={() => handleApprove(selectedAgency._id)}
                      ...
                      <button
                        onClick={() => handleReject(selectedAgency._id)}
                        disabled={actionLoading}
                  ...
                  <button
                    onClick={() => handleDelete(selectedAgency._id)}
                    disabled={actionLoading}
