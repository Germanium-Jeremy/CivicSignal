  ...
  return (
    <section className="px-4 md:px-8 lg:px-30 py-12 md:py-16 flex flex-col lg:flex-row gap-8 lg:gap-20 items-center bg-white">
      <div className="flex flex-col gap-4 md:gap-6 py-4 text-center lg:text-left">
        ...
        <p className="text-sm md:text-base text-neutral-text max-w-lg mx-auto lg:mx-0">
          CivicSignal is available on both mobile and desktop platforms.
          Download now and start making a difference in your community
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 md:gap-6 items-center justify-center w-full lg:w-auto">
        ...
        <p className="text-sm md:text-lg text-neutral-text">
          Or you can get the app from...
        </p>
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full sm:w-auto">
          <button
