...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
     try {
          ...
          const issue = await Issue.findById(id).select("_id title description category status priority location photos assignedTo trackingNumber").lean();
...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
     try {
          ...
          const issue = await Issue.findByIdAndUpdate(id, updates, {
               ...
               "_id title description category status priority location photos assignedTo trackingNumber",
               )
               .lean();
