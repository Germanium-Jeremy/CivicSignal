...
export default function AcknowledgedIssuesPage() {
    ...
    const fetchAcknowledgedIssues = async () => {
        try {
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-neutral-text mt-1">
                        Issues that have been reviewed and acknowledged by agency staff
                    </p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-light-gray">
                <div className="p-6 border-b border-light-gray">
                    <h2 className="text-lg font-semibold text-almost-black">Acknowledged Issues</h2>
                </div>
                <div className="divide-y divide-light-gray">
                            ...
                            <div key={issue._id} className="p-6 hover:bg-light-gray/30 transition-colors">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center shrink-0">
                                        <FaCheckCircle className="text-orange-600" size={16} />
                                    </div>
                                                ...
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <span 
                                                        ...
                                                        style={{ 
                                                            ...
                                                            color: priorityColors[issue.priority.toLowerCase() as keyof typeof priorityColors] 
                                                        }}
                                                    >
                                                        {issue.priority}
                                                    </span>
                    ...
                    {filteredIssues.length === 0 && (
                        <div className="p-12 text-center">
                            ...
                            <p className="text-neutral-text">No acknowledged issues found</p>
                            <p className="text-sm text-gray-400 mt-1">
                                Issues that have been acknowledged by agency staff will appear here.
                            </p>
                        </div>
                    )}
                </div>
