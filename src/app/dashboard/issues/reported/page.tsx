...
export default function ReportedIssuesPage() {
  ...
  const handleStatusChange = (issue: Issue) => {
    ...
    setNewStatus(
      issue.status as "submitted" | "acknowledged" | "pending" | "resolved",
    );
    setStatusComment("");
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-lg font-semibold text-almost-black mb-4">
            Issue Details
          </h2>
          {activeIssue ? (
            <div className="bg-white rounded-xl p-6 shadow-sm border border-light-gray">
              <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-medium">
                        ...
                        {activeIssue.trackingNumber
                          ? activeIssue.trackingNumber.split("-")[1]
                          : "N/A"}
                      </span>
                      <span
                        className="px-3 py-1 rounded-full text-sm font-medium"
                        style={{
                          backgroundColor: `${priorityColors[activeIssue.priority.toLowerCase() as keyof typeof priorityColors]}20`,
                          color:
                            priorityColors[
                              activeIssue.priority.toLowerCase() as keyof typeof priorityColors
                            ],
                        }}
                      >
                ...
                {/* Issue Description */}
                <div>
                  <h4 className="font-semibold text-almost-black mb-2">
                    Description
                  </h4>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-neutral-text text-sm">
                      {formatDate(
                        activeIssue.submittedAt || activeIssue.createdAt,
                      )}
                    </p>
                  </div>
                  <div>
      ...
      {statusModalOpen && selectedIssue && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            <h3 className="text-xl font-bold text-almost-black mb-4">
              Change Issue Status
            </h3>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={
                  isUpdatingStatus || newStatus === selectedIssue.status
                }
